...
public class Scrabble {
	...
	public static String createHand() {
		String myHand = MyString.randomStringOfLetters(HAND_SIZE -2);
		myHand = MyString.insertRandomly('a', myHand);
		myHand = MyString.insertRandomly('e', myHand);
		return myHand;
	}
	...
	public static Boolean inHand(String hand, String word){
		for (int i =0; i < word.length(); i++) {
			if (!MyString.subsetOf(""+word.charAt(i), hand)){
				return false;
			}
		}
		return true;
